...
final Map<String, NutrientReference> kKDRIs2025 = {
  ...
  'copper_mcg': NutrientReference(
    name: '구리',
    unit: 'mcg',
    matrix: _matrix({
      KAgeBracket.adult19to29: (800, 800),
      KAgeBracket.adult30to49: (800, 800),
      KAgeBracket.adult50to64: (800, 800),
      KAgeBracket.elderly65to74: (800, 800),
      KAgeBracket.elderly75plus: (800, 800),
    }),
    pregnancyAdd: 130,
    lactationAdd: 480,
    upperLimit: 10000,
